...
<body id="body-pd">
	...
	<header class="header" id="header">
		...
		<div class="dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
				<a class="dropdown-item" href="#">User</a> <a class="dropdown-item"
					href="#">${correo}</a> <a class="dropdown-divider"></a>
				<form method="post" action="/ClassKeeper/LoginController">
					<input type="hidden" name="accion" value="Salir">
					<button type="submit" class="dropdown-item"><i class='bx bx-log-out nav_icon'></i> Salir</button>
				</form>
			</div>
		</div>
	</header>
	<div class="l-navbar" id="nav-bar">
		<nav class="nav">
			<div>
				...
				<div class="nav_list">
					<a href="dashboard.jsp" class="nav_link active"> <i
					...
					<a id="enlace-crud-profesor" href="#" class="nav_link">
	...
	<div id="container-padre" style="margin-top: 50px"
		...
		<div class="container mt-4">
			<h1>
				Bienvenido al sistema <strong> Usuario:${correo}</strong>
			</h1>
		</div>
